						...
						if( BERAnalysis$BERData$calcBERStatsDataExists()){
							box(status = "primary", title = "Consumer Products Exposition Analysis Table", collapsible = TRUE, width = 12,
								dropdownButton(
									  ...
									  HTML( 
										str_c( 
												"<p>This shows the Consumer Products Exposition values in ug/day for each category of exposure.</p>"
										)
									  ),
									  circle = TRUE, status = "danger", icon = icon("question-circle"), width = "300px",
									  tooltip = NULL
								...
								dropdownButton(
									  ...
									  HTML( 
										str_c( 
												...
												"<p><strong>Warning:</strong> Ac50 values are being used here instead of OED, since there is not enough data for most chemicals to calculate OED</p>"
										)
									  ),
									  circle = TRUE, status = "danger", icon = icon("question-circle"), width = "300px",
									  tooltip = NULL
